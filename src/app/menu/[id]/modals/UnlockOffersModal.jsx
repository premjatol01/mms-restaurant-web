...
const UnlockOffersModal = ({ onClose }) => {
  return (
    <div className="absolute bottom-0 z-99 left-0 bg-white w-full max-w-md rounded-t-[32px] sm:rounded-t-[32px] p-6 shadow-lg animate-in slide-in-from-bottom-8 duration-300">
      ...
      <button
        onClick={onClose}
        className="absolute -top-3.5 right-5 p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full transition-colors bg-white hover:shadow-md"
      >
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm leading-relaxed">
          Login with your mobile number to apply offers and get order updates on
          WhatsApp.
        </p>
      </div>
